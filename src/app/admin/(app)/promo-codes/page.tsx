  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10">
      <PageHeader
        ...
        subtitle="Coupons shown on the public Coupons page"
        action={
          <PrimaryLink href="/admin/promo-codes/new">
              ...
              {promos.map((p) => (
                <tr key={p.PROMO_ID} className="border-b border-slate-50 last:border-0 hover:bg-slate-50">
                  ...
                  <td className="px-5 py-3 text-right whitespace-nowrap">
                    <Link href={`/admin/promo-codes/${p.PROMO_ID}/edit`} className="text-slate-400 hover:text-gw-brand p-2 inline-block">
                      <FaEdit />
                    </Link>
